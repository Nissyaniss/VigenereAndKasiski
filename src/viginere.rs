use crate::utils::{get_value_ascii_table, is_in_ascii_table, ASCIILIMIT, ASCIITABLE};
...
pub fn encrypt(text: String, key: String) -> String {
	...
	for i in 0..text.len() {
		...
		if text_current_char_as_int == 32 {
			result.push(' ');
		} else {
...
pub fn decrypt(text: String, key: String) -> String {
	...
	for i in 0..text.len() {
		...
		let mut final_char: i32 = text_current_char_as_int as i32 - key_current_char_as_int as i32;
